...
struct Day17 {
  ...
  static func printPath(
    max: (Int, Int), cameFrom: [NodeReference: NodeReference], end: NodeReference
  ) {
  ...
  static func runAStar(
    grid: [[Int]], start: Point, goal: Point, minStraight: Int = 0, maxStraight: Int = 3
  ) -> Int {
    var allNodes = [
      Node(
    ...
    while !openSet.isEmpty() {
      ...
      for dir in [Direction]([.n, .e, .s, .w]) {
        if curr.dir.flipped() == dir || (curr.dir != dir && curr.straightCount < minStraight)
